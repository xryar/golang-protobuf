...
import (
	product "golang-protobuf/pb/ecommerce/product"
...
const file_ecommerce_order_order_proto_rawDesc = "" +
	"\n" +
	"\x1becommerce/order/order.proto\x12\x0fecommerce.order\x1a\x1fecommerce/product/product.proto\"i\n" +
	"\x05Order\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x126\n" +
	"\bproducts\x18\x03 \x03(\v2\x1a.ecommerce.product.ProductR\bproductsB\x1aZ\x18golang-protobuf/pb;orderb\x06proto3"
